...
from Analyzer.service.base import service_logger
    ...
    def send_emails_4_ia(self,
        ...
        try:
            self.send_emails_base(
                ...
                inline_images=[("Analyzer/static/ziggy.jpg", "analyzer")]
            )
...
if __name__ == '__main__':
    ...
    email_service.send_emails_4_ia(user_name='刘硕',ia_id='123456',report_path='Analyzer/static/report.pdf',user_email=['your_email@qq.com'])